object DlgDiasTrabalhados: TDlgDiasTrabalhados
  Left = 420
  Top = 197
  Width = 523
  Height = 273
  ...
  object Panel1: TPanel
    ...
    object edtDiasTrabalhados: TEdit
      Left = 128
      Top = 96
      Width = 121
      Height = 21
  ...
  object sp_Gerar_Dias: TSQLStoredProc
    NoMetadata = True
    GetMetadata = False
    MaxBlobSize = -1
    Params = <
    ...
    StoredProcName = 'SP_GERAR_DIAS_TRABALHADOS'
    Left = 440
    Top = 24
  end
end
