inherited frmCadTomador: TfrmCadTomador
  ...
  inherited RzPageControl1: TRzPageControl
    ...
    inherited TS_Consulta: TRzTabSheet
      ...
      inherited SMDBGrid1: TSMDBGrid
        Width = 990
        Height = 508
        DataSource = DMCadTomador.dsConsulta
        ColCount = 14
        Columns = <
          item
            Expanded = False
          ...
          inherited pnlCadastro: TPanel
            ...
            object Panel1: TPanel
              ...
              object DBEdit1: TDBEdit
                ...
                DataSource = DMCadTomador.dsTomador
                TabOrder = 0
              end
            ...
            object pnlGrid_Dias: TPanel
              ...
              object SMDBGrid2: TSMDBGrid
                ...
                Height = 335
                Align = alClient
                DataSource = DMCadTomador.dsTomadorDiasTrabalhados
            ...
            object pnlBotoesDias: TPanel
              ...
              Align = alLeft
              TabOrder = 2
              object btnInserirDias: TNxButton
                Left = 1
                Top = 0
                Width = 48
                Height = 65
                ...
                TabOrder = 0
                OnClick = btnInserirDiasClick
              end
              object btnAlterarDias: TNxButton
                Left = 1
                Top = 64
                Width = 48
                Height = 65
                ...
                TabOrder = 1
                OnClick = btnAlterarDiasClick
              end
              object btnExcluirDias: TNxButton
                Left = 1
                Top = 128
                Width = 48
                Height = 65
                ...
                TabOrder = 2
                OnClick = btnExcluirDiasClick
              end
              object btnConfirmarDias: TNxButton
                Left = 1
                Top = 193
                Width = 48
                Height = 65
                ...
                TabOrder = 3
                OnClick = btnConfirmarDiasClick
              end
              object btnCancelarDias: TNxButton
                Left = 1
                Top = 257
                Width = 48
                Height = 65
  ...
  object popOpcoes: TPopupMenu
    Left = 905
    Top = 60
    object AtualizaDeptoSage1: TMenuItem
      Caption = 'Buscar Tomador Sage'
      OnClick = AtualizaDeptoSage1Click
    end
    object GerarDiasTrabalhados1: TMenuItem
      Caption = 'Gerar Dias Trabalhados'
      OnClick = GerarDiasTrabalhados1Click
    end
  end
end
