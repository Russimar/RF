...
//  ShowMessage(IntToStr(ID_Funcionario));
//  ShowMessage(IntToStr(ID_Filial));
...
procedure TfrmRelVA_VT.ComboEmpresaChange(Sender: TObject);
begin
  vFilial := fDMSage.cdsEmpresacd_empresa.AsInteger;
end;
